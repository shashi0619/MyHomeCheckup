...
const ServiceCard5 = ({ image, title }: Props) => {
  return (
...
Advanced thermographic camera and moisture meter scan to detect water leakages, wall dampness, and hidden seepage points.</p>
