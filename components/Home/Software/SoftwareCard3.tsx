...
const SoftwareCard3 = ({ icon, title }: Props) => {
  return (
...
List of minor and major defects that need correction for a flawless handover experience.      </p>
